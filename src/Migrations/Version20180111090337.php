 ...
 */
class Version20180111090337 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('DROP INDEX IDX_6C215D1AD712F7BD');
        $this->addSql('DROP INDEX IDX_6C215D1A83269723');
        ...
        $this->addSql('CREATE TABLE books_genres (book_Id INTEGER UNSIGNED NOT NULL, genre_Id INTEGER UNSIGNED NOT NULL, PRIMARY KEY(book_Id, genre_Id), CONSTRAINT FK_6C215D1A83269723 FOREIGN KEY (book_Id) REFERENCES app_books (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_6C215D1AD712F7BD FOREIGN KEY (genre_Id) REFERENCES app_genres (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
