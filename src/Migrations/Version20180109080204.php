 ...
 */
class Version20180109080204 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__app_notifications AS SELECT id, receiver_id, title, content FROM app_notifications');
        $this->addSql('DROP TABLE app_notifications');
        $this->addSql('CREATE TABLE app_notifications (id INTEGER NOT NULL, receiver_id INTEGER DEFAULT NULL, title VARCHAR(255) NOT NULL COLLATE BINARY, content VARCHAR(255) NOT NULL COLLATE BINARY, PRIMARY KEY(id), CONSTRAINT FK_FA7D8D7FCD53EDB6 FOREIGN KEY (receiver_id) REFERENCES app_users (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO app_notifications (id, receiver_id, title, content) SELECT id, receiver_id, title, content FROM __temp__app_notifications');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE author (id INTEGER NOT NULL, first_name VARCHAR(255) NOT NULL COLLATE BINARY, last_name VARCHAR(255) NOT NULL COLLATE BINARY, country VARCHAR(255) NOT NULL COLLATE BINARY, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE book (id INTEGER NOT NULL, bookserie_id INTEGER DEFAULT NULL, isbn VARCHAR(255) NOT NULL COLLATE BINARY, title VARCHAR(255) NOT NULL COLLATE BINARY, pages INTEGER NOT NULL, language VARCHAR(255) NOT NULL COLLATE BINARY, publisher VARCHAR(255) NOT NULL COLLATE BINARY, publication_date DATETIME NOT NULL, available_copies INTEGER NOT NULL, reserved_copies INTEGER NOT NULL, cover VARCHAR(255) NOT NULL COLLATE BINARY, annotation VARCHAR(255) NOT NULL COLLATE BINARY, rating DOUBLE PRECISION NOT NULL, times_borrowed INTEGER NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_CBE5A3313E2B4156 ON book (bookserie_id)');
        $this->addSql('CREATE TABLE book_reservation (id INTEGER NOT NULL, book_id INTEGER DEFAULT NULL, reader_id INTEGER DEFAULT NULL, date_from DATETIME NOT NULL, date_to DATETIME NOT NULL, status VARCHAR(255) NOT NULL COLLATE BINARY, fine DOUBLE PRECISION NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE comment (id INTEGER NOT NULL, book_id INTEGER DEFAULT NULL, user_id INTEGER DEFAULT NULL, published_at DATETIME NOT NULL, content VARCHAR(255) NOT NULL COLLATE BINARY, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_9474526C16A2B381 ON comment (book_id)');
        $this->addSql('CREATE INDEX IDX_9474526CA76ED395 ON comment (user_id)');
        $this->addSql('CREATE TABLE genre (id INTEGER NOT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE notification (id INTEGER NOT NULL, receiver_id INTEGER DEFAULT NULL, title VARCHAR(255) NOT NULL COLLATE BINARY, content VARCHAR(255) NOT NULL COLLATE BINARY, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_BF5476CACD53EDB6 ON notification (receiver_id)');
        $this->addSql('CREATE TABLE user (id INTEGER NOT NULL, first_name VARCHAR(255) NOT NULL COLLATE BINARY, last_name VARCHAR(255) NOT NULL COLLATE BINARY, registered_at DATETIME NOT NULL, photo VARCHAR(255) NOT NULL COLLATE BINARY, username VARCHAR(25) NOT NULL COLLATE BINARY, email VARCHAR(60) NOT NULL COLLATE BINARY, password VARCHAR(64) NOT NULL COLLATE BINARY, roles CLOB NOT NULL COLLATE BINARY --(DC2Type:json_array)
        , PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__app_notifications AS SELECT id, receiver_id, title, content FROM app_notifications');
        $this->addSql('DROP TABLE app_notifications');
        $this->addSql('CREATE TABLE app_notifications (id INTEGER NOT NULL, receiver_id INTEGER DEFAULT NULL, title VARCHAR(255) NOT NULL, content VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO app_notifications (id, receiver_id, title, content) SELECT id, receiver_id, title, content FROM __temp__app_notifications');
        $this->addSql('DROP TABLE __temp__app_notifications');
        $this->addSql('CREATE INDEX IDX_FA7D8D7FCD53EDB6 ON app_notifications (receiver_id)');
        $this->addSql('DROP INDEX IDX_2DFDA3CBF675F31B');
