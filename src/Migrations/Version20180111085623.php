 ...
 */
class Version20180111085623 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE books_genres (book_id INTEGER UNSIGNED NOT NULL, genre_id INTEGER UNSIGNED NOT NULL, PRIMARY KEY(book_id, genre_id), CONSTRAINT FK_6C215D1A16A2B381 FOREIGN KEY (book_id) REFERENCES app_books (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_6C215D1A4296D31F FOREIGN KEY (genre_id) REFERENCES app_genres (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
